...
class ProfileViewModel @Inject constructor(private val repository: ProfileRepository): ViewModel() {
    ...
    private val _getAccountDataList = MutableLiveData<UiState<List<UserData>>>()
    val getAccountDataList: LiveData<UiState<List<UserData>>>
        get() = _getAccountDataList
    ...
    fun getAccountDataList(inputSearch: String) {
        _getAccountDataList.value = UiState.Loading
        repository.getSearchUsername(inputSearch) {
            _getAccountDataList.value = it
        }
    }
